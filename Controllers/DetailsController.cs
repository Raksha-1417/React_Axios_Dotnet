...
using React_Axios_Dotnet.Models;

namespace React_Axios_Dotnet.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class DetailsController : ControllerBase
    {
        private readonly ReactAxiosAPIContext _context;

        public DetailsController(ReactAxiosAPIContext context)
        {
            _context = context;
        }
